...
export const blurTransition = { duration: 1.15, ease: [0.25, 0.1, 0.25, 1] };

export const blurVariants = {
  hidden: { filter: "blur(20px)", transform: "translateY(24%) scale(0.98)", opacity: 0 },
  visible: { filter: "blur(0px)", transform: "translateY(0%) scale(1)", opacity: 1 },
};
